...
type IconProps = {
  name: 'plus' | 'trash' | 'edit' | 'chef-hat' | 'bell' | 'x-circle' | 'check-circle' | 'calendar' | 'zap';
  className?: string;
};
...
const ICONS: Record<IconProps['name'], React.ReactNode> = {
  ...
  'chef-hat': <path strokeLinecap="round" strokeLinejoin="round" d="M15.362 5.214A3.75 3.75 0 0 1 19.112 9v2.25c0 1.065-.21 2.097-.6 3.072-1.558 3.86-5.26 6.178-9.012 6.178s-7.454-2.318-9.012-6.178c-.39- .975-.6-2.007-.6-3.072V9a3.75 3.75 0 0 1 3.75-3.75h1.214c.254 0 .5.105.684.286l.516.516a.63.63 0 0 0 .89 0l.516-.516a.937.937 0 0 1 .684-.286h2.236a.937.937 0 0 1 .684.286l.516.516a.63.63 0 0 0 .89 0l.516-.516a.937.937 0 0 1 .684-.286h1.214Zm-12 11.25a.375.375 0 1 0 0-.75.375.375 0 0 0 0 .75Z" />,
  ...
  calendar: <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0h18M-4.5 12h18" />,
